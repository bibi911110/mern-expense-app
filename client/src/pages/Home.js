...
import { AddForm, Spinner, ExpenseItem, MonthSelector, Statistics } from '../components';
    ...
    render() {
        ...
        return (
            <div style={{ marginTop: 30 }}>
                <MonthSelector months={MONTHS} onSelectMonth={this.onSelectMonth.bind(this)} selected={selected} />
                <h3>Expense List</h3>
                <hr />
